defmodule MapperWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers MapperWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MapperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MapperWeb.Gettext, "errors", msg, opts)
    end
  end
